...
<div class="float-right w-75">
                        ...
                        <div class="ibox-body">
                            ...
                            <div class="flexbox mb-4">
                                ...
                                <div class="input-group-icon input-group-icon-left mr-3">
                                    ...
                                    <a class="btn btn-primary btn-sm" href="<?php echo base_url() ?>suporte/abrir_chamado"><span><i class="menu-icon icon-plus"></i> Abrir</span></a>
                                </div>
                            </div>
                                        ...
                                        <?php
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button class="btn btn-success btn-sm" data-toggle="modal" data-target="#modal_detalhes" onclick="busca_detalhes(<?php echo $chamado->id ?>)"><span><i class="menu-icon icon-inbox"></i> DETALHES</span></button>
                                                    </td>

                                                    <?php if($suporte == 1){ ?>
                                                        <td style="text-align: center">
                                                            <a href="<?php echo base_url() ?>suporte/editar/<?php echo $chamado->id ?>" class="btn btn-warning btn-sm"><span><i class="menu-icon icon-pencil"></i> EDITAR</span></a>
                                                        </td>
                                                    <?php }  ?>
    ...
    <div class="modal modalDetalhes" id="modal_detalhes" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
          ...
          <div class="modal-footer" style="text-align: center;">
            <button type="button" class="btn btn-primary" onclick="$('#modal_detalhes').fadeOut('fast')">Sair</button>
          </div>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
	...
	function editar($id){
        ...
        //console.log($);
		$.ajax({
	            url:"<?php echo base_url() ?>suporte/editar",
	            method:"POST",
	            dataType: 'json',
	            data:{id:id},
	            success:function(data){
